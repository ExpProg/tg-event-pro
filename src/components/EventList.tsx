...
const demoEvents: Event[] = [
  {
    ...
    organizerId: 123456789, // Демо ID организатора
    isActive: true,
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    organizerId: 987654321, // Демо ID организатора
    isActive: true,
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    organizerId: 456789123, // Демо ID организатора
    isActive: true,
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    organizerId: 789123456, // Демо ID организатора
    isActive: true,
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    organizerId: 321654987, // Демо ID организатора
    isActive: true,
    createdAt: new Date(),
    updatedAt: new Date(),
  },
